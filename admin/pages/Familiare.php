...
<! -----------------contenido -----------------!>
    ...
    <div class="container-fluid">
        ...
        $consulta = "SELECT  u.id_user, u.DNI, u.nombre, u.apellidoPaterno, u.apellidoMaterno, u.contacto, u.email, u.pass, td.descripcion AS tipo_documento, r.descripcion AS rol
                        FROM 
                            Usuario u
                        INNER JOIN 
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $dat['apellidoPaterno']; ?> <?php echo $dat['apellidoMaterno']; ?></td>
                            ...
                            <td>
                                <div class="text-center">
                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editarUser<?php echo $dat['id_user']; ?>">
