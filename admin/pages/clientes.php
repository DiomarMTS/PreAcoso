...
<! -----------------contenido -----------------!>
    ...
    <div class="container-fluid">
        ...
        $consulta = "SELECT u.id_usuario, u.nombre, u.apellido, u.nombre_usuario, u.email, u.fecha_registro, u.Estado, r.nombre_rol 
                FROM usuarios u
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-center">
                                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editarCliente<?php echo $dat['id_usuario']; ?>">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>
                                        <a href="../config/Delete/eliminarCliente.php?id=<?php echo $dat['id_usuario']; ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este registro?')">
