...
$consulta = "SELECT `id_producto`, `nombre`, `stock`, `stockMin`
            FROM `productos`
...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(0, 10, 'REPORTE PRODUCTO CON STOCK MINIMO', 0, 0, 'C');
        $this->Ln(20);
    }
...
$pdf->Ln(10);
$pdf->Cell(0, 10, 'Emitido por: Daniel Casani Garcia', 0, 1, 'L'); 
$pdf->Cell(0, 10, 'Usuario: Administrador', 0, 1, 'L'); 
