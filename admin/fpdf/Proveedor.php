...
$consulta = "SELECT `nombre`, `direccion`, `telefono`, `email`, `RUC`, `Estado` FROM `proveedores`";
...
class PDF extends FPDF
{
   // Cabecera de página
    function Header()
    {
        ...
        $this->Cell(0, 10, 'REPORTE DE PROVEEDORES ', 0, 0, 'C'); // Centrar el título del reporte
        $this->Ln(20);
    }
...
$pdf->Output('ReporteProveedor.pdf', 'I');
?>
