...
$consulta = "SELECT `nombre`, `direccion`, `telefono`, `email`, `RUC`, `Estado` FROM `proveedores` WHERE Estado='Activo';";
...
class PDF extends FPDF
{
   // Cabecera de página
    function Header()
    {
        ...
        $this->Cell(0, 10, 'REPORTE DE PROVEEDORES ACTIVOS', 0, 0, 'C'); // Centrar el título del reporte
        $this->Ln(20);
    }
...
$pdf->Output('ReporteProveedorAcrivo.pdf', 'I');
?>
